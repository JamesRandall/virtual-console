...
The full palette is a fixed palette based on Tailwind and has 256 colors in total. By default the 8bpp palette is indexed with this layout.

Palettes index into this fixed palette using the palette space as described in the memory layout.
